...
# Overview
The Gold Layer is the business_level data representation, Structured to support analytical and reporting use cases. It consists of **dimension tables** and **fact tables**
...
| subcategory | NVARCHAR(50) | A more detailed classification of the product within the category, such as product ty... |
